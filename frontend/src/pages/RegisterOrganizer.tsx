...
import { ArrowLeft, Mail, Lock, User, Building2, Facebook, Apple } from 'lucide-react';
import { SEO } from '../components/SEO';
import { registerOrganizer, registerOrganizerSchema } from '../lib/auth';
import { toast } from 'react-hot-toast';

export const RegisterOrganizer: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Validate form data
      const validatedData = registerOrganizerSchema.parse({
        organizerName,
        firstName,
        lastName,
        email,
      ...
      setLoading(true);
      const { success } = await registerOrganizer(validatedData);
  ...
  return (
    <>
      <SEO 
        ...
        description="Créez votre compte organisateur Event Ease et commencez à gérer vos événements."
      />
      ...
      <div className="min-h-screen bg-white dark:bg-black">
        <div className="grid lg:grid-cols-2 min-h-screen">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url("https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")',
            ...
            <div className="relative h-full flex items-center justify-center p-12">
              <div className="w-full max-w-lg">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Créez et gérez vos événements en toute simplicité. Rejoignez notre communauté d'organisateurs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center p-6 lg:p-12">
            <div className="w-full max-w-md">
              ...
              {/* Form Header */}
              <div className="mb-8">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Créez votre compte organisateur</h2>
                <p className="text-gray-600 dark:text-gray-400">
                  Commencez à créer et gérer vos événements
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="organizerName" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                ...
                <button
                  ...
                  disabled={loading}
                >
                  {loading ? 'Inscription en cours...' : 'Créer mon compte organisateur'}
                </button>
